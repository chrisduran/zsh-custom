#Makes LS Colors in Linux adhere to BSD/Darwin conventions, with Cyan directories (for black BGs)
...
#Modify BSD LSCOLORS to keep consistency with directory coloring (non-sticky global accesss now also cyan)
LSCOLORS="Gxfxcxdxbxegedabadacag"; export LSCOLORS

#Bluify directories for BSD, if desired
